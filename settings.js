...
global.alivemsg = `~_*🙏山モㄥ匚口爪モ*🙏 🏴‍☠️*_

       🇱🇰⃟ 𝙷𝙴𝚈 𝚃𝙷𝙴𝚁𝙴 𝙱𝙾𝚃 𝙾𝙽𝙻𝙸𝙽𝙴 𝙽𝙾𝚆 ⃟🇱🇰

    *හායි මම ඉන්නවා. මොකෝ කරන්නෙ ඔයා❤️        ඔන්න ඔයා ඕන දෙයක් ගන්න මගෙන්🥲❤️*

 

🙈⃝𝙱𝙾𝚃 𝙲𝚁𝙴𝙰𝚃𝙴𝙳 𝙱𝚈 Yumal Widunitha 

  

🙈⃝𝚃𝙷𝙰𝙽𝙺𝚂 𝙵𝙾𝚁 𝚄𝚂𝙸𝙽𝙶 𝙾𝚄𝚁 𝚂𝙴𝚁𝚅𝙸𝙲𝙴   

 

🙈⃝𝙱𝙾𝚃 𝙲𝚁𝙴𝙰𝚃𝙴𝚁 -YumalWidu

         🪂  Yw 𝙾𝙵𝙵𝙸𝙲𝙸𝙰𝙻 𝙱𝙾𝚃 🪂

🇱🇰⃟ 𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 Yumal Widunitha  ⃟🇱🇰` //Costomize Alive Message (type your message in `` )
...
global.ownername = "🔥yumalwidu🔥" // owner name
...
global.botname = 'WIDU╺ MD - 𝘉𝘖𝘛' //ur bot name
global.packname = "Bot Sticker" // sticker packname
global.author = "WIDU╺ BOT" // sticker author
global.dragonemoji = '🧩' // Menu emoji
global.footer = '[ ◉ widu-ᴍᴅ ]' //
...
global.mess = {
    ...
    caption: 'Generated by: ◉ *Yumalwidu-md*'
} // END \\
    global.limitawal = {
    premium: "Infinity",
    free: 12,
